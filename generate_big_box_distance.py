...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/media/fandong/SUNHAO-1T-STU/i18R/TEST/ANNOTATION/escalator/right")
    parser.add_argument('--output_dir', type=str,
                        default="/media/fandong/SUNHAO-1T-STU/i18R/TEST/ANNOTATION/escalator1/right")
    ...
    for xml_file in tqdm(xml_path_list):
        ...
        for i in range(len(Object)):
            if str(Object[i].find('name').text)=='escalator_handrails_model':
                ...
                dis=int(Object[i].find('distance').text)
            ...
            if str(Object[i].find('name').text)=='escalator_model':
                ...
                continue
        if is_escalator and is_escalator1:
            ...
            element4_1=create_node("distance", {}, str(dis))
