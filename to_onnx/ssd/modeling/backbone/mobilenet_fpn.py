...
class MobileNetFPNV2(nn.Module):
    def __init__(self, width_mult=1.0, inverted_residual_setting=None):
        super(MobileNetFPNV2, self).__init__()
...
@registry.BACKBONES.register('mobilenet_fpn')
def mobilenet_fpn(cfg, pretrained=True):
    model = MobileNetFPNV2()
    if pretrained:
