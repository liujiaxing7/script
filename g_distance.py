...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/media/fandong/SUNHAO-1T-STU/i18R/TEST/ANNOTATION/escalator/in_place/4.5m")
    parser.add_argument('--output_dir', type=str,
                        default="/media/fandong/SUNHAO-1T-STU/i18R/TEST/ANNOTATION/escalator/in_place/4.5m")
    ...
    for xml_file in tqdm(xml_path_list):
        ...
        for i in range(len(Object)):
            if str(Object[i].find('name').text)=='escalator_handrails_model':
                # ymin = Object[i].find('bndbox').find('ymin').text # 修改节点文本
                ...
                Object[i].find('distance').text=str(450)
