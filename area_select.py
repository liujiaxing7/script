...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', type=str, default="/media/fandong/SUNHAO-1T-STU/i18R/ANNOTATION/20210612")
    parser.add_argument('--output_dir', type=str, default="/media/fandong/SUNHAO-1T-STU/i18R/ANNOTATION_REMOVE/20210612")
    args=parser.parse_args()

    xml_path_list = get_xml(args.input_dir)
    for xml_file in tqdm(xml_path_list):
        if 'rgb' in xml_file:
            area = args.area*2.5*2.5
        else:
            area = args.area
        ################ 1. 读取xml文件  ##########
