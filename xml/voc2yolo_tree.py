...
def voc2yolo(rootpath, xmlname, classes):
    ...
    dst_path = base_path.replace('imglab', 'labels')
...
if __name__ == "__main__":
    ...
    classes =['shoes', 'bin', 'pedestal', 'wire', 'socket', 'cat', 'dog','desk_rect','desk_circle']
    ...
    xml_list = read_xml_list('/mnt/sdb2/20220825_table/imglab/0825.txt')
